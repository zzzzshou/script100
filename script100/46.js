...
if (u.prototype.convert = function (t) {
    ...
    if (!(n.t <= 0)) {
        ...
        if (0 != u) {
            ...
            for (; 0 <= --g;) {
                ...
                if ((i[p] += a.am(0, m, i, g, 0, s)) < m)
                    for (a.dlShiftTo(g, h), i.subTo(h, i); i[p] < --m;)
                        i.subTo(h, i)
            }
    ...
    if ("Netscape" == navigator.appName && navigator.appVersion < "5" && window.crypto && window.crypto.random)
        for (var g = window.crypto.random(32), h = 0; h < g.length; ++h)
...
function getpwd(t) {
    ...
    var t = e.join("")
    var n = new o;
    n.setPublic("", "10001")
    return Base64.encode(Hex.decode(n.encrypt(t)))
