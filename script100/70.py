...
des_create_keys= function(key) {
                var pc2bytes0 = [0, 0x4, 0x20000000, 0x20000004, 0x10000, 0x10004, 0x20010000, 0x20010004, 0x200, 0x204, 0x20000200, 0x20000204, 0x10200, 0x10204, 0x20010200, 0x20010204]
                  ...
                  , pc2bytes7 = [0, 0x10000, 0x800, /*0x10800*/
                67584, 0x20000000, 0x20010000, 0x20000800, /*0x20010800*/
                536938496, 0x20000, 0x30000, 0x20800, 0x30800, 0x20020000, 0x20030000, 0x20020800, 0x20030800]
            ...
            encode_4399=function(str, key) {
                return str_to_hex(des(key, encodeURIComponent(str), 1, 0));
            }
